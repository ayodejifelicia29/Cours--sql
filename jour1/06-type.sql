--en js
-- dans  une variable on distingue 5 type de base
...
--- vous allez avoir des catégories => distinguent par le nomber de caractéres quelles contiennent

VARCHAR (0-255) colonne dont stocker texte maximum de 
                255 caratères seul type qui dispose de (0-255) =  2^8 = 256
...
--3 date 
DATE  =>  AAAA-MM-JJ
( 01/12/2023 => date francais non) 
Attention en sql => 2023-12-01
DATETIME  AAAA-MM-JJ HH:MM:SS (2023-12-01 12:30:01)
TIME   HH:MM:SS (12:30:01)
TIMESTAMP ( MySql non disponible )


1/12/2023 => date en français 
attention en sql =>  "2023-12-01"
...
--auteur texte max de 20 letters
